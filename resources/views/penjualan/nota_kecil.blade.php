...
<body onload="window.print()">
    ...
    <p style="margin-bottom: 0;">No. {{ tambah_nol_didepan($penjualan->id_penjualan, 6) }}</p>
    ...
    <table width="100%" style="border: 0;">
        @foreach ($detail as $item)
            ...
            <tr>
                <td>{{ $item->jumlah }} * {{ format_uang($item->harga_jual) }}</td>
                <td></td>
    ...
    {{-- Set COOKIE Untuk ukuran Tinggi Page Nota Print --}}
    <script>
        ...
        // Converted PX to MM   // + 50 untuk memberi space di bagian TERIMAKASIH jika itemnya banyak
