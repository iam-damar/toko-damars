    ...
    <div class="col-md-12">
        <div class="box">
                    ...
                    <div class="col-lg-4">
                        <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="POST">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-btn">
                                            <button onclick="tampilMember()" class="btn btn-primary btn-flat" type="button"><i class="fa fa-angle-down"></i></button>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-8">                                                           {{-- cek apakah memberselected kosong? jika ya set diskon jadi 0 --}}
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary btn-flat pull-right btn-simpan"><i class="fa fa-floppy-o"> Simpan Transaksi</i></button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(function (){
        ...
        //Jika ingin mengcollapse sidebar saat masuk dashboard
        ...
        $(document).on('input', '.quantity', function(){
            ...
            if (jumlah < 1) {
                $(this).val(1);
                alert('Jumlah Stok tidak boleh kurang dari 1');
                return;
            }
    ...
    function deleteData(url) {
        if (confirm("Ingin menghapus Data terpilih?")) {
            $.post(url, {
                ...
                .fail((errors) => {
                    alert("Tidak dapat menghapus data pembelian");
                    return;
                })
        }
    };
