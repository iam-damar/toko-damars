            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        <label for="tanggal_awal" class="col-md-3 col-md col-offset-2 control-label">Tanggal Awal</label>
                        <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        <label for="tanggal_akhir" class="col-md-3 col-md col-offset-2 control-label">Tanggal Akhir</label>
                        <div class="col-md-6">
