    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{ url(auth()->user()->foto ?? '') }}" class="img-circle image-profil" alt="User Image">
        </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        @if (auth()->user()->level == 1)
            ...
            <li>
                <a href="{{ route('laporan.index') }}">
                    <i class="fa fa-file-pdf-o"></i> <span>Laporan Toko</span>
                </a>
            </li>
        ...
        @else
            ...
            <li>
                <a href="{{ route('kasir.penjualan') }}" target="_blank">
                    <i class="fa fa-history "></i> <span>Riwayat Transaksi</span>
                </a>
            </li>
            <li>
                <a href="{{ route('kasir.daftar_produk') }}" target="_blank">
